...
export function MakingPredictionsModule() {
  ...
  const handleComplete = () => {
    markModuleComplete('making-predictions')
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">Making Predictions</h1>
          <p className="text-gray-400">How inputs become outputs</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        {step < totalSteps - 1 ? (
          ...
          <Link
            to="/learn/measuring-mistakes"
            onClick={handleComplete}
            className="btn-primary flex items-center gap-2"
          >
            Continue to Measuring Mistakes
            <ArrowRight className="w-4 h-4" />
          </Link>
        )}
      </div>
