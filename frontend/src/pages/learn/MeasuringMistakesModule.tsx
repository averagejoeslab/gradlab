...
export function MeasuringMistakesModule() {
  ...
  const handleComplete = () => {
    markModuleComplete('measuring-mistakes')
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">Measuring Mistakes</h1>
          <p className="text-gray-400">How we know when we're wrong</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        {step < totalSteps - 1 ? (
          ...
          <Link
            to="/learn/finding-what-to-fix"
            onClick={handleComplete}
            className="btn-primary flex items-center gap-2"
          >
            Continue to Finding What to Fix
            <ArrowRight className="w-4 h-4" />
          </Link>
        )}
      </div>
